...
> This file is the OpenAI Codex equivalent of CLAUDE.md. It tells Codex and other
> OpenAI-compatible agents how to work with this repository effectively.
> Content is kept in sync with CLAUDE.md — if they diverge, CLAUDE.md is authoritative.
...
This project ships an MCP server at `agentops_mcp/server.py`. Configure it in your Codex MCP settings to get tool access:
...
Available tools: `deploy_agentops_framework`, `scaffold_agent_project`, `run_evaluation_suite`,
`read_deployment_manifest`, `monitor_deployment`, `submit_trace_feedback`, `export_negative_traces`
...
- Evaluation gate failures and scaffold placeholder entries (section 8)
